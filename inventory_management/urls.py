...
urlpatterns = [
    ...
    path('produtos/criarprodutos/', CreateProductView.as_view(), name='create_product'),
    path('produtos/editarprodutos/<uuid:product_id>/', ProductUpdateView.as_view(), name = 'edit_product'),
